...
const social = {
  data: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/watizat',
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/assowatizat',
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/channel/UCiGGJfoofWJeqJrXc70bnRw/videos',
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
