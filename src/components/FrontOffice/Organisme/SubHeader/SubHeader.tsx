        ...
        <div className="flex items-center justify-between max-w-2xl mx-auto gap-x-8 lg:mx-0 lg:max-w-none">
          <div className="flex items-center gap-x-10">
            <button
              ...
              className="hidden gap-2 px-3 py-2 text-sm font-semibold text-gray-900 bg-transparent rounded-md shadow-sm md:flex ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
            >
