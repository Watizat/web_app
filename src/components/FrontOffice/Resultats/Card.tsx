      ...
      <div className="grid border-t grid-col-2 md:grid-col-3 md:divide-x md:divide-y-0">
        <div className="flex flex-1 w-full lg:col-start-1">
          <Link
            ...
            target="_blank"
            className="relative inline-flex items-center justify-center flex-1 w-0 py-2 text-sm font-semibold border-transparent rounded-br-lg text-slate-600 lg:py-3 gap-x-3"
          >
        ...
        {organism.phone && (
          <div className="flex flex-1 w-full border-l md:col-start-2">
            <Link
              ...
              className="relative inline-flex items-center justify-center flex-1 w-0 py-2 text-sm font-semibold border border-transparent rounded-br-lg text-slate-600 lg:py-3 gap-x-3"
            >
