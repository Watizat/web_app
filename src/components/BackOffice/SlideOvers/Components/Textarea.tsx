...
export default function Textarea({ data, formMethods }: Props) {
    ...
    <div>
      ...
      <div>
        <textarea
          ...
          className="pl-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-slate-300 focus:ring-2 focus:ring-inset focus:ring-watizat-600 sm:text-sm sm:leading-6"
        />
      </div>
      {data.required && (
