      ...
      <Container>
        <div>
          ...
          <p>
            ...
            75018 PARIS (cette adresse est une boîte aux lettres, nous n’y
            sommes pas présents)
          </p>
          ...
          <p className={styles.title2}>
            Législation française relative au droit d’accès au fichier
            informatisé
          </p>
          <p>
            Conformément à la loi française N· 78-17 du 6 janvier 1978 relative
            à l’informatique, aux fichiers et aux libertés (CNIL), tout
            utilisateur·ice ayant déposé sur ce site des informations
          ...
          <p>
            Malgré nos efforts pour nous assurer de la fiabilité des
            informations contenues sur ce site Internet, WATIZAT ne peut
            encourir aucune responsabilité du fait d’erreurs, d’omissions ou
            pour les résultats qui pourraient être obtenus par l’usage des
            informations, données ou contenus téléchargeables, qu’elles soient
            de notre fait ou du fait de tiers partenaires qui nous les
            fournissent. En conséquence, l’utilisateur·ice reconnaît utiliser
            ces informations sous sa responsabilité exclusive.
          </p>
          <p>
            Par ailleurs l’usage des liens hypertextes peut conduire vers
            d’autres serveurs sur lesquels WATIZAT n’a aucun contrôle et ne
